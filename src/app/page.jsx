      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="flex gap-2 mb-4">
          <div className="flex-1">
            <label htmlFor="newTask" className="sr-only">Nome da tarefa</label>
            <input
              id="newTask"
          ...
          <div>
            <label htmlFor="newDescription" className="sr-only">Descrição da tarefa</label>
            <input
              id="newDescription"
        ...
        <div className="flex justify-center gap-3 mb-6">
          {['todas', 'pendente', 'concluída'].map(status => (
            <button
              ...
              aria-label={`Filtrar por tarefas ${status}`}
